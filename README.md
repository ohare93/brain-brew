...
After the alpha.5 release gates pass and the maintainer manually publishes it to crates.io, Rust users can install the current preview crate:
...
nix run . -- --help
nix build .#brainbrew
nix run github:jeprecated/brain-brew/v1.0.0-alpha.5 -- --help
```
